...
<%@ page
	import="fr.keepplayin.model.Utilisateur,java.util.List,java.text.SimpleDateFormat,java.util.Date,java.lang.Boolean,fr.keepplayin.model.Publication,fr.keepplayin.model.Commentaire,java.util.Collections"%>
...
<%
	Utilisateur u;
	Boolean enVisite = (Boolean) request.getAttribute("visite");
	if (enVisite) {
		u = (Utilisateur) request.getAttribute("utilisateurVisite");
	} else {
...
<div class="container profil-container">
	<div class="infos-profil col-md-4">
		...
		<div class="photo-profil col-md-12 shadow border">
			...
			<div class="names-profil col-md-6">
				<span class="names"><%= u.getPrenom() %></span><span class="names">
					<%= u.getNom() %></span>
			</div>
			<div class="pseudo-profil col-md-6">
				<span class="pseudo">
					<% if(u.getNomDeScene() == null) { out.print("Aucun nom de scène"); } else { out.print(u.getNomDeScene()); } %>
				</span>
			</div>
		...
		<div class="infos-container col-md-12">
			<div class="row shadow border infos-details">
				<label>Instruments</label><a href="#"><span
					class="badge badge-custom">5</span></a>
			...
			<div class="row shadow border infos-details">
				<label>Genres de musique</label><a href="#"><span
					class="badge badge-custom">7</span></a>
				<div class="list-group">
					<a href="#" class="list-group-item">First item</a> <a href="#"
						class="list-group-item">Second item</a> <a href="#"
						class="list-group-item">Third item</a>
	...
	<%
  		Boolean estAmi = (Boolean) request.getAttribute("ami");
  		if (estAmi != null && estAmi) {
  	%>
			<div class="row">
				<div class="col-md-2">
					<img src="photo-profil.jpg" alt="Avatar du post"
						class="img-thumbnail height-publi">
				</div>
				<div class="col-md-10 name-publi">
					<form name="publication_form connectedText" method="post"
						action="/publi">
						<div class="form-group">
							<textarea required="true" class="form-control publi"
								name="message" rows="3" placeholder="Rock'n Roll Baby !"></textarea>
						</div>
	...
	%>
		...
		<div class="thumbnail border shadow padding_top col-md-12">
			<div class="row">
				<div class="col-md-3">
					<img src="photo-profil.jpg" alt="Avatar du post"
						class="img-thumbnail height-105">
				</div>
			...
			<div class="row">
				<form name="publication_form connectedText" method="post"
					...
					<div class="form-group col-md-9">
						<input type="text" required="true" class="form-control publi"
							name="message" placeholder="Quelque chose à dire ?">
						</textarea>
					</div>
					<input type="hidden" value="<%= u.getId() %>" name="id"> <input
						type="hidden" value="<%= p.getId() %>" name="id_publi">
    	...
    	%>
		<div
			class="thumbnail border_comment shadow_comment col-md-10 col-md-offset-2 margin_comment">
			<%
    			}
    	...
    	%>
			<div class="row">
				<div class="col-md-2">
					<img src="photo-profil.jpg" alt="Avatar du commentaire"
						class="img-thumbnail height-comment">
				</div>
